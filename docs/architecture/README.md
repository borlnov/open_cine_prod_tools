...
| [exports.md](exports.md) | The export panel every mode reaches its documents from, `OcptExportManager` and its twenty services, the door a foreign screenplay comes in through, the scenario coverage PDF | `lib/managers/export/`, `lib/ui/pages/workspace/widgets/` (the export dialog) |

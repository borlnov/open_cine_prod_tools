...
/// picked one of the mode's five ledgers to attach the movement to.
///
...
/// every one of the five still travels in `OcptBudgetEntryFormFields` regardless of which was
...
enum OcptBudgetEntryLinkKind {
  ...
  /// A person the production owes for having advanced money on its behalf — `people`, through
  /// `budget_entries.personId`. Names a défraiement debt, never a financing resource, which is the

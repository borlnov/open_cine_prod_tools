...
/// themes managers, and the [MixinLicensesConfig] variables required by the licenses manager,
/// this is a placeholder for future configuration options. Add [ConfigVar] fields here as the app
/// grows, following RFL24: no configuration value must be hardcoded outside of this manager and
/// its bundled YAML files.

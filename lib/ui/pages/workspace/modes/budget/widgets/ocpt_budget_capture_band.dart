...
/// widget, on the mode's two working surfaces alone — `OcptBudgetView.expenses` and
/// `OcptBudgetView.resources`. **Withheld whole, not disabled,**
...
class OcptBudgetCaptureBand extends StatefulWidget {
  ...
  /// `OcptBudgetView.resources`, `true` (a debit) on `OcptBudgetView.expenses`. The toggle itself
  /// stays reachable on both: a credit typed on the quote is simply a credit.

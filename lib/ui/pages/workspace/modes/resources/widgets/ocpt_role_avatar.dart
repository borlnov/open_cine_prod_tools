...
///
/// A cast role is drawn by [OcptPersonAvatar], so an actor's photo — or, failing that, their
/// palette colour and initials — is theirs rather than the role's: casting the same actor in two
/// roles shows the same circle twice, which is exactly the point. This widget owns the **uncast**
/// half alone, which is the half a person has no answer for.
class OcptRoleAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (castMember != null) {
      return OcptPersonAvatar(person: castMember, radius: radius);
    }

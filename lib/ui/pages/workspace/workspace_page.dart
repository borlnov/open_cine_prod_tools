...
///
/// Each mode (the screenplay editor, the breakdown, the shot list, the resources catalogue, the
/// schedule or the budget) builds its own `OcptWorkspaceShell` filling the space above the
/// switcher; the switcher itself lives here, outside every mode's shell, so a mode never has to
/// know about it, let alone thread its active value and selection callback through.
///

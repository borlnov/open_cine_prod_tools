...
/// it down cleanly on `SIGINT`/`SIGTERM`.
///
...
/// test with no socket involved. This file's own job is only: read the bind address, serve, log
/// one startup line, and shut down cleanly. See this package's own `README.md` for every
/// environment variable and how to run this behind a reverse proxy.
library;

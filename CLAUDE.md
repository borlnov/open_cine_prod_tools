...
| 12    | PDF screenplay export (`pdf` package, options dialog: page format pre-filled from project + scene-numbers checkbox, Courier Prime embedded, pagination via `FountainLayoutMetrics`, title page)          | ⬜                                   |
